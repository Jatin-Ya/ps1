...
exports.fileContents = exports.filePaths = exports.getRepos = exports.getFiles = exports.getCodeScannerAlerts = exports.getDependabotAlerts = void 0;
...
const getDependabotAlerts = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    const ownerName = (_a = user === null || user === void 0 ? void 0 : user.githubId) === null || _a === void 0 ? void 0 : _a.userName;
    const repoName = project === null || project === void 0 ? void 0 : project.repoName;
    const token = (_b = user === null || user === void 0 ? void 0 : user.githubId) === null || _b === void 0 ? void 0 : _b.accessToken;
    if (!token)
        return next((0, app_error_1.error401)("Unauthorized"));
    try {
        const alerts = yield githubService.getDependabotAlerts(token, ownerName, repoName);
...
const getCodeScannerAlerts = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    const { projectId } = req.query;
    // const headers = req.headers.authorization;
    // const token = headers?.split(" ")[1];
    ...
    if (!user)
        return next((0, app_error_1.error401)("Unauthorized"));
    const ownerName = (_c = user === null || user === void 0 ? void 0 : user.githubId) === null || _c === void 0 ? void 0 : _c.userName;
    ...
    if (!token)
        return next((0, app_error_1.error401)("Unauthorized"));
    try {
        const alerts = yield githubService.getCodeScannerAlerts(token, ownerName, repoName);
        next((0, app_error_1.success200)(alerts));
    }
    catch (err) {
        next((0, app_error_1.error400)("Could'nt fetch code scanner alerts"));
    }
});
...
const getFiles = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!token)
        return next((0, app_error_1.error401)("Unauthorized"));
    try {
        const files = yield (0, GithubUtils_1.getFilesAndPaths)(token, ownerName, repoName);
...
const getRepos = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _g;
    const { email } = req.query;
    const user = yield userModel_1.default.findOne({ email: email });
    const token = (_g = user === null || user === void 0 ? void 0 : user.githubId) === null || _g === void 0 ? void 0 : _g.accessToken;
...
const filePaths = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ownerName = project === null || project === void 0 ? void 0 : project.repoDetails.repoOwner;
    const repoName = project === null || project === void 0 ? void 0 : project.repoDetails.repoName;
    const token = (_h = user === null || user === void 0 ? void 0 : user.githubId) === null || _h === void 0 ? void 0 : _h.accessToken;
    if (!token)
        return next((0, app_error_1.error401)("Unauthorized"));
    const filePaths = yield githubService.getPathsOfFilesFromBranch(token, ownerName, repoName, "master");
    next((0, app_error_1.success200)(filePaths));
});
...
const fileContents = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ownerName = project === null || project === void 0 ? void 0 : project.repoDetails.repoOwner;
    const repoName = project === null || project === void 0 ? void 0 : project.repoDetails.repoName;
    const token = (_j = user === null || user === void 0 ? void 0 : user.githubId) === null || _j === void 0 ? void 0 : _j.accessToken;
    if (!token)
        return next((0, app_error_1.error401)("Unauthorized"));
    const fileContents = yield githubService.getFiles(token, ownerName, repoName, [filePath]);
    next((0, app_error_1.success200)(fileContents));
});
