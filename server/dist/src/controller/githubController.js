...
const getFiles = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const project = yield projectModel_1.default
      .findById(projectId)
      .populate("users");
    console.log({ scanProject: project });
    if (!project)
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const repoName =
      project === null || project === void 0
        ...
        : project.repoDetails.repoName;
    const token =
      (_h = user === null || user === void 0 ? void 0 : user.githubId) ===
        null || _h === void 0
        ? void 0
        : _h.accessToken;
    if (!token) return next((0, app_error_1.error401)("Unauthorized"));
    const filePaths = yield githubService.getPathsOfFilesFromBranch(
      token,
      ownerName,
      repoName,
      "master"
...
const fileContents = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _j;
    ...
    const repoName =
      project === null || project === void 0
        ...
        : project.repoDetails.repoName;
    const token =
      (_j = user === null || user === void 0 ? void 0 : user.githubId) ===
        null || _j === void 0
        ? void 0
        : _j.accessToken;
    if (!token) return next((0, app_error_1.error401)("Unauthorized"));
    const fileContents = yield githubService.getFiles(
      token,
      ownerName,
      repoName,
      [filePath]
