...
router.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (role === "User") {
            ...
            const manager = yield managerModel_1.default.findOne({ email: email });
            if ((manager === null || manager === void 0 ? void 0 : manager.password) !== password) {
                return res.status(401).send("Incorrect Password");
            }
            res.send(manager);
        }
...
router.get("/github", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.get("/github/callback", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const resp = yield axios_1.default.get("https://api.github.com/user", {
            headers: {
