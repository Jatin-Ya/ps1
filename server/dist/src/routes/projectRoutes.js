...
router.get("/getById/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const project = yield projectModel_1.default.findById(id).populate("users");
...
router.get("/belongsTo", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (role === "Manager") {
            const projects = yield projectModel_1.default.find({ manager: userid }).populate("users");
            return res.send(projects);
        }
        else if (role === "User") {
...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const manager = yield managerModel_1.default.findOne({ email: manager_email });
