...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const projects = yield projectModel_1.default.find(filters).populate("users");
    return res.send(projects);
}));
router.get("/belongsTo", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { title, description, guidlines, manager_email, users_email, aiSupport, } = req.body;
        users_email.push(manager_email);
        console.log({ body: req.body });
        const manager = yield userModel_1.default.findOne({ email: manager_email });
        if (!manager)
            return res.status(401).send("Manager not found");
        ...
        console.log({ project });
        const usersQuery = users_email.map((email) => userModel_1.default.findOne({ email }));
...
router.patch("/addUsers", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id, user: useremail } = req.body;
        const userDoc = yield userModel_1.default.findOne({ email: useremail });
        const projectDoc = yield projectModel_1.default.findOne({ _id: id });
        if (!userDoc)
...
router.patch("/removeUser", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id, user: useremail } = req.body;
        const userDoc = yield userModel_1.default.findOne({ email: useremail });
        const projectDoc = yield projectModel_1.default.findOne({ _id: id });
        ...
        projectDoc.users = projectDoc.users.filter((u) => u.toString() !== userDoc._id.toString());
        userDoc.projects = userDoc.projects.filter((p) => p.toString() !== projectDoc._id.toString());
        const [project, user] = yield Promise.all([
            projectDoc.save(),
            userDoc.save(),
        ]);
...
router.post("/query/escalate", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/query/resolve", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.patch("/connectRepo", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
